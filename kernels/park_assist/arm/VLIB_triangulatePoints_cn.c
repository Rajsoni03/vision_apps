...
#include "../common/VLIB_internal.h"
#include "../common/VLIB_utility.h"
*/
    ...
    for( l = 0; l < totalTracks; l += VLIB_TRIANG_NUM_TRACKS_IN_ONE_VECTOR ) {
        for( k = 0; k < VLIB_TRIANG_NUM_TRACKS_IN_ONE_VECTOR; k++ ) {
            ...
            for( i = (VLIB_TRIANG_MAX_POINTS_IN_TRACK - curTrackLengthL); i < VLIB_TRIANG_MAX_POINTS_IN_TRACK; i++ ) {
                ...
                W       += (normCamExtPrmL[14] * Xcam[1 * VLIB_TRIANG_NUM_TRACKS_IN_ONE_VECTOR + k]);
                W       += (normCamExtPrmL[16] * Xcam[2 * VLIB_TRIANG_NUM_TRACKS_IN_ONE_VECTOR + k]);
                W       += (normCamExtPrmL[18] * 1.0f);
                /* Even if the change in weight is small then continue doing triangulation
                * dont break
                */
                oneByW                              = VLIB_OneByXF32(W);
...
*
*/
//CODE_SECTION(solve3x3MatEq,  ".text:ansi")
static void solve3x3MatEq(VLIB_F32 matAtAPtr[],
                          VLIB_F32 matBPtr[],
                          VLIB_F32 resultPtr[],
                          uint8_t valid[],
...
*
*/
//CODE_SECTION(solve3x3MatEqDouble,  ".text:ansi")
static void solve3x3MatEqDouble(VLIB_F32 matAtAPtr[],
                                VLIB_F32 matBPtr[],
                                VLIB_F32 resultPtr[],
                                uint8_t valid[],
...
*
*/
//CODE_SECTION(solve3x3MatEqDoubleSelect,  ".text:ansi")
static void solve3x3MatEqDoubleSelect(VLIB_F32 matAtAPtr[],
                                      VLIB_F32 matBPtr[],
                                      VLIB_F32 resultPtr[],
                                      uint8_t valid[],
...
//CODE_SECTION(VLIB_triangulatePoints_cn,  ".text:ansi")
