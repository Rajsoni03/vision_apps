...
edgeai_check_paths:
	@if [ ! -d $(EDGEAI_APPS_UTILS_PATH) ]; then echo 'ERROR: $(EDGEAI_APPS_UTILS_PATH) not found !!!'; exit 1; fi
...
edgeai:
	...
	$(MAKE) edgeai_apps_utils
	$(MAKE) edgeai_kernels
	$(MAKE) edgeai_modules
	$(MAKE) edgeai_plugins

edgeai_apps_utils:
	@echo "Building EdgeAI Apps Utils"
	cd $(EDGEAI_APPS_UTILS_PATH); \
	mkdir build; \
	cd build; \
...
edgeai_install:
	@echo "Install EdgeAI Apps Utils, Kernels, Modules and Plugins to EDGEAI_INSTALL_PATH"
	cd $(EDGEAI_APPS_UTILS_PATH); \
