...
ifeq ($(BUILD_CPU_MCU1_0),yes)
	...
	cp $(VISION_APPS_PATH)/out/J7/R5F/SYSBIOS/$(QNX_APP_PROFILE)/vx_app_tirtos_qnx_mcu1_0.out $(QNX_AUX_FS_PATH)/lib/firmware/j7-mcu-r5f0_0-fw
	$(TIARMCGT_ROOT)/bin/armstrip -p $(QNX_AUX_FS_PATH)/lib/firmware/j7-mcu-r5f0_0-fw
endif

ifeq ($(BUILD_CPU_MCU2_0),yes)
	# copy remote firmware files for mcu2_0
	cp $(VISION_APPS_PATH)/out/J7/R5F/SYSBIOS/$(QNX_APP_PROFILE)/vx_app_tirtos_qnx_mcu2_0.out $(QNX_AUX_FS_PATH)/lib/firmware/j7-main-r5f0_0-fw
...
ifeq ($(BUILD_CPU_MCU2_1),yes)
	...
	cp $(VISION_APPS_PATH)/out/J7/R5F/SYSBIOS/$(QNX_APP_PROFILE)/vx_app_tirtos_qnx_mcu2_1.out $(QNX_AUX_FS_PATH)/lib/firmware/j7-main-r5f0_1-fw
...
ifeq ($(BUILD_CPU_MCU3_0),yes)
	...
	cp $(VISION_APPS_PATH)/out/J7/R5F/SYSBIOS/$(QNX_APP_PROFILE)/vx_app_tirtos_qnx_mcu3_0.out $(QNX_AUX_FS_PATH)/lib/firmware/j7-main-r5f1_0-fw
...
ifeq ($(BUILD_CPU_MCU3_1),yes)
	...
	cp $(VISION_APPS_PATH)/out/J7/R5F/SYSBIOS/$(QNX_APP_PROFILE)/vx_app_tirtos_qnx_mcu3_1.out $(QNX_AUX_FS_PATH)/lib/firmware/j7-main-r5f1_1-fw
...
ifeq ($(BUILD_CPU_C6x_1),yes)
	...
	cp $(VISION_APPS_PATH)/out/J7/C66/SYSBIOS/$(QNX_APP_PROFILE)/vx_app_tirtos_qnx_c6x_1.out $(QNX_AUX_FS_PATH)/lib/firmware/j7-c66_0-fw
...
ifeq ($(BUILD_CPU_C6x_2),yes)
	...
	cp $(VISION_APPS_PATH)/out/J7/C66/SYSBIOS/$(QNX_APP_PROFILE)/vx_app_tirtos_qnx_c6x_2.out $(QNX_AUX_FS_PATH)/lib/firmware/j7-c66_1-fw
...
ifeq ($(BUILD_CPU_C7x_1),yes)
	...
	cp $(VISION_APPS_PATH)/out/J7/C71/SYSBIOS/$(QNX_APP_PROFILE)/vx_app_tirtos_qnx_c7x_1.out $(QNX_AUX_FS_PATH)/lib/firmware/j7-c71_0-fw
