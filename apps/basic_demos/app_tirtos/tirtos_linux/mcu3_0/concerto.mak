...
TARGET      := vx_app_tirtos_linux_mcu3_0
TARGETTYPE  := exe
...
LDIRS += $(PDK_PATH)/packages/ti/drv/ipc/lib/j721e/mcu3_0/$(TARGET_BUILD)/
LDIRS += $(PDK_PATH)/packages/ti/drv/udma/lib/j721e/mcu3_0/$(TARGET_BUILD)/
LDIRS += $(PDK_PATH)/packages/ti/drv/sciclient/lib/j721e/mcu3_0/$(TARGET_BUILD)/
